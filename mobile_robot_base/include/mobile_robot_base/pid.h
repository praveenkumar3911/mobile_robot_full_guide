...
#include <mobile_robot_base/ParametersConfig.h>
...
namespace mobile_robot_base
{
    ...
    public:
        ...
        void updateDynamicReconfig(mobile_robot_base::ParametersConfig config);

        /**
         * \brief Update the PID parameters from dynamics reconfigure
         */
        void dynamicReconfigCallback(mobile_robot_base::ParametersConfig &config, uint32_t /*level*/);
    ...
    private:
        ...
        typedef dynamic_reconfigure::Server<mobile_robot_base::ParametersConfig> DynamicReconfigServer;
