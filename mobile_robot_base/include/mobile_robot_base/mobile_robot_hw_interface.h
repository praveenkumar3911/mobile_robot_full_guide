#ifndef mobile_robot_HW_INTERFACE_H
#define mobile_robot_HW_INTERFACE_H
...
#include <mobile_robot_msgs/AngularVelocitiesStamped.h>
...
#include <mobile_robot_base/pid.h>
...
namespace mobile_robot_base
{
    ...
    class mobile_robotHWInterface : public hardware_interface::RobotHW
    {
    public:
        /**
         * \brief Constructor
         ...
         */
        mobile_robotHWInterface(ros::NodeHandle &nh, urdf::Model *urdf_model = NULL);

        /** \brief Destructor */
        virtual ~mobile_robotHWInterface() {}
    ...
    protected:
        ...
        void encoderTicksCallback(const mobile_robot_msgs::EncodersStamped::ConstPtr& msg_encoders);
        ...
        // mobile_robot directly calculates normalized angles from encoder ticks
        ...
        /** \brief mobile_robot reports travel distance in metres, need radians for ros_control RobotHW */
        double linearToAngular(const double &distance) const;
        /** \brief RobotHW provides velocity command in rad/s, mobile_robot needs m/s. */
        ...
        // The parameters are defined in mobile_robot_base/config/base.yaml
        ...
        // This subscriber receives the encoder ticks in the custom mobile_robot_msgs/Encoder message
        ...
        // This subscriber receives the measured angular wheel joint velocity in the custom mobile_robot_msgs/AngularVelocitiesStamped message
    ...
    };  // class mobile_robotHWInterface

}  // namespace

#endif // mobile_robot_HW_INTERFACE_H
