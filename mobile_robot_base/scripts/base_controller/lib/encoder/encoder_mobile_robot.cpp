...
mobile_robot::Encoder::Encoder(ros::NodeHandle& nh, uint8_t pin1, uint8_t pin2, int encoder_resolution)
  : nh_(nh)
  , encoder(pin1, pin2)
...
mobile_robot::JointState mobile_robot::Encoder::jointState()
{
...
double mobile_robot::Encoder::angularPosition()
{
    return joint_state_.angular_position_;
}


double mobile_robot::Encoder::angularVelocity()
{
    return joint_state_.angular_velocity_;
}

double mobile_robot::Encoder::ticksToAngle(const int &ticks) const
{
...
int mobile_robot::Encoder::getRPM()
{
    long encoder_ticks = encoder.read();
