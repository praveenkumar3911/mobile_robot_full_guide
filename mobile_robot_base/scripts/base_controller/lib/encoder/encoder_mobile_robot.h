...
#ifndef mobile_robot_ENCODER_H
#define mobile_robot_ENCODER_H
...
namespace mobile_robot
{
    ...
    public:
        ...
        /** \brief Construct a mobile_robot::Encoder providing access to quadrature encoder ticks and angular joint velocity.
         * 
