#ifndef _ROS_mobile_robot_msgs_WheelsCmdStamped_h
#define _ROS_mobile_robot_msgs_WheelsCmdStamped_h
...
#include "mobile_robot_msgs/WheelsCmd.h"
...
namespace mobile_robot_msgs
{
  ...
  class WheelsCmdStamped : public ros::Msg
  {
    public:
      ...
      _header_type header;
      typedef mobile_robot_msgs::WheelsCmd _wheels_cmd_type;
    ...
    virtual const char * getType() override { return "mobile_robot_msgs/WheelsCmdStamped"; };
