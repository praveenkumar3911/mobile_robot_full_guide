#ifndef _ROS_mobile_robot_msgs_AngularVelocities_h
#define _ROS_mobile_robot_msgs_AngularVelocities_h
...
namespace mobile_robot_msgs
{
  ...
  class AngularVelocities : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "mobile_robot_msgs/AngularVelocities"; };
