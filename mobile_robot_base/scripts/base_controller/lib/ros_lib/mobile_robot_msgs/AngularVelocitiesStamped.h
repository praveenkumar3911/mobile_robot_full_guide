#ifndef _ROS_mobile_robot_msgs_AngularVelocitiesStamped_h
#define _ROS_mobile_robot_msgs_AngularVelocitiesStamped_h
...
namespace mobile_robot_msgs
{
  ...
  class AngularVelocitiesStamped : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "mobile_robot_msgs/AngularVelocitiesStamped"; };
