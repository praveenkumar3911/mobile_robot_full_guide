#ifndef _ROS_mobile_robot_msgs_EncodersStamped_h
#define _ROS_mobile_robot_msgs_EncodersStamped_h
...
#include "mobile_robot_msgs/Encoders.h"
...
namespace mobile_robot_msgs
{
  ...
  class EncodersStamped : public ros::Msg
  {
    public:
      ...
      _header_type header;
      typedef mobile_robot_msgs::Encoders _encoders_type;
    ...
    virtual const char * getType() override { return "mobile_robot_msgs/EncodersStamped"; };
