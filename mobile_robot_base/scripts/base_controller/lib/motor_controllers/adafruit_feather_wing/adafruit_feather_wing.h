...
namespace mobile_robot {
    ...
    class AdafruitMotorController : public MotorControllerIntf<Adafruit_MotorShield>
    {
        public:
             ...
             * 
             * Specify the motor to control \p motor_num (use 3 or 4 for mobile_robot).
             ...
             * the PCB.
             * 
             * \param motor_num Number of the motor to control (one of 1, 2, 3, 4). mobile_robot uses motors 3 and 4.
