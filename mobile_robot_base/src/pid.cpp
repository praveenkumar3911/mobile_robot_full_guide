...
namespace mobile_robot_base
{
    ...
    void PID::updateDynamicReconfig()
    {
        ...
        // Get starting values
        mobile_robot_base::ParametersConfig config;
        config.f = f_;
    ...
    void PID::updateDynamicReconfig(mobile_robot_base::ParametersConfig config)
    {
        // Make sure dynamic reconfigure is initialized
        if(!dynamic_reconfig_initialized_)
            return;
    ...
    void PID::dynamicReconfigCallback(mobile_robot_base::ParametersConfig &config, uint32_t /*level*/)
    {
